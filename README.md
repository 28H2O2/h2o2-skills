...
| Skill | 用途 |
|-------|------|
| [h2o2-bilibili-subtitle-extractor](./skills/h2o2-bilibili-subtitle-extractor/) | 从 B 站视频页提取 AI 字幕轨，转存 JSON 并生成纯文本语料 |
| [h2o2-arxiv-paper](./skills/h2o2-arxiv-paper/) | 搜索/下载 arXiv 论文 TeX 源码，生成结构化中文摘要（实验、基线、关键数字） |
| [h2o2-make-ppt](./skills/h2o2-make-ppt/) | 基于已下载的 arXiv 论文生成 3 张 PPT + 讲稿，含溢出检测 |
